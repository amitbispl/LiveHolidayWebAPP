...
!(function (a, b) {
    ...
    j.prototype = {
        ...
        _process_options: function (e) {
            ...
            if (
                (f.startDate !== -(1 / 0) &&
                    (f.startDate ? (f.startDate instanceof Date ? (f.startDate = this._local_to_utc(this._zero_time(f.startDate))) : (f.startDate = q.parseDate(f.startDate, h, f.language))) : (f.startDate = -(1 / 0))),
        ...
        place: function () {
            ...
            var b = this.picker.outerWidth(),
                ...
                d = this.picker.offset().top,
                //d = a(this.o.container).width(),
            ...
            if (
                ("auto" === r && ((p = -g + o - c), (q = g + f - (o + l + c)), (r = Math.max(p, q) === q ? "top" : "bottom")),
        ...
        updateNavArrows: function () {
            if (this._allow_update) {
                ...
                //            this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear() ? this.picker.find(".next").css({ visibility: "hidden" }) : this.picker.find(".next").css({ visibility: "visible" });
                //}
                //debugger;
                //switch (this.viewMode) {
                //    case 0:
                //        this.o.startDate !== -(1 / 0) && b <= this.o.startDate.getUTCFullYear() && c <= this.o.startDate.getUTCMonth()
                //            ? this.picker.find(".prev").prop("disabled", true)
                //            : this.picker.find(".prev").prop("disabled", false),
                //            this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear() && c >= this.o.endDate.getUTCMonth()
                //            ? this.picker.find(".next").prop("disabled", true)
                //            : this.picker.find(".next").prop("disabled", false);
                //        break;
                //    case 1:
                //    case 2:
                //        this.o.startDate !== -(1 / 0) && b <= this.o.startDate.getUTCFullYear() ? this.picker.find(".prev").prop("disabled", true) : this.picker.find(".prev").prop("disabled", false),
                //            this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear() ? this.picker.find(".next").prop("disabled", true) : this.picker.find(".next").prop("disabled", false);
                //}
                ...
                switch (this.viewMode) {
                    ...
                    case 1:
                    case 2:
                        // Month or day view mode
                        if (this.o.startDate !== -(1 / 0) && b <= this.o.startDate.getUTCFullYear()) {
                        ...
                        if (this.o.endDate !== 1 / 0 && b >= this.o.endDate.getUTCFullYear()) {
